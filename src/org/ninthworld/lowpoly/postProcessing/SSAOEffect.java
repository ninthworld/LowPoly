...
public class SSAOEffect {
    ...
    public void render(int colorTexture, int depthTexture, int normalTexture, int skyboxTexture){
        ...
        ssaoShader.loadInvProjectionMatrix(invProjectionMatrix);
        ssaoShader.loadSamples(samples);
        renderer.renderQuad();
        ssaoShader.stop();
    }
