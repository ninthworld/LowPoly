...
public class PostProcessing {
	...
	public static void doPostProcessing(int colorTexture, int depthTexture, int normalTexture, int skyboxTexture){
		start();
        ssaoEffect.render(colorTexture, depthTexture, normalTexture, skyboxTexture);
		end();
	}
