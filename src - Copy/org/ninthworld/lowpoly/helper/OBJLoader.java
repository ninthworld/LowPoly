...
public class OBJLoader {
    ...
    public static RawModel loadOBJ(Loader loader, File file) throws IOException {
        Vector3f[] colorList = new Vector3f[]{
                new Vector3f(61/255f, 40/255f, 9/255f),
                new Vector3f(76/255f, 110/255f, 33/255f)
        };
        ...
        for(int[][] intArray : indicesList){
            for(int i=0; i<intArray.length; i++){
                ...
                colors[vert] = colorList[intArray[i][1]].x;
                colors[vert+1] = colorList[intArray[i][1]].y;
                colors[vert+2] = colorList[intArray[i][1]].z;
            }
